...
export const PrivacyText = (
	<div>
		...
		<p>
			<b>We don't save your data!</b> It stays inside of your device and belongs only to you. We only use cookies to
...
export const PrivacyPolicy = (
	<>
		...
		<ul>
			...
			<li>
				<strong>Website</strong> refers to d-cide, accessible from d-cide.me
			</li>
			<li>
		...
		<p>
			...
			device when You go offline, while Session Cookies are deleted as soon as You close your web browser. Learn more about
			cookies in the <a href='https://www.privacypolicies.com/blog/cookies/'>"What Are Cookies"</a> article.
		</p>
		...
		<p>
			...
			&mdash; and maintained on &mdash; computers located outside of Your state, province, country or other governmental
		...
		<p>
			Service Providers have access to Your Personal Data only to perform their tasks on Our behalf and are obligated not
		...
		<p>
			...
			<a href='mailto:hey@d-cide.me'>hey@d-cide.me</a>
		</p>
	</>
);
