...
export const PrivacyPolicy = (
	<div>
		...
		<p>
			Your privacy is important to us. It is d-cide's policy to respect your
			privacy regarding any information we may collect from you across our
			website,{" "}
			<a href="https://d-cide.herokuapp.com">https://d-cide.herokuapp.com</a>,
	...
	<div>
		...
		<ol type="a">
			<li>
				...
				(information or software) on d-cide's website for personal,
			...
			<li>
				...
				restrictions and may be terminated by d-cide at any time. Upon
		...
		<ol type="a">
			<li>
				The materials on d-cide's website are provided on an 'as is' basis.
				d-cide makes no warranties, expressed or implied, and hereby disclaims
			...
			<li>
				Further, d-cide does not warrant or make any representations concerning
		...
		<h3>4. Limitations</h3>
		<p>
			In no event shall d-cide or its suppliers be liable for any damages
			...
			materials on d-cide's website, even if d-cide or a d-cide authorized
		...
		<p>
			The materials appearing on d-cide's website could include technical,
			typographical, or photographic errors. d-cide does not warrant that any of
			the materials on its website are accurate, complete or current. d-cide may
			make changes to the materials contained on its website at any time without
			notice. However d-cide does not make any commitment to update the
			materials.
		</p>
		<h3>6. Links</h3>
		<p>
			d-cide has not reviewed all of the sites linked to its website and is not
			responsible for the contents of any such linked site. The inclusion of any
			link does not imply endorsement by d-cide of the site. Use of any such
			linked website is at the user's own risk.
		</p>
		<h3>7. Modifications</h3>
		<p>
			d-cide may revise these terms of service for its website at any time
		...
		<p>
			...
			with the laws of Bavaria, Germany and you irrevocably submit to the
